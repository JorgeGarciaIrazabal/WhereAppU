...
PMA_messages['strAbortedRequest'] = "Petición abortado!!";
...
PMA_messages['strFunctionHint'] = "Presione Shift al pulsar sobre el nombre de la función para aplicarla a todas las filas.";
...
PMA_messages['phpErrorsFound'] = "<div class=\"error\">¡Se detectaron algunos errores en el servidor!<div>Revise el pie de esta ventana.<input id=\"pma_ignore_errors_popup\" type=\"submit\" value=\"Ignorar\" style=\"float: right; margin: 20px;\"><input id=\"pma_ignore_all_errors_popup\" type=\"submit\" value=\"Ignorar todos\" style=\"float: right; margin: 20px;\"></div></div>";
